...
describe('total likes', () => {
  ...
  test('when list has only one blog equals the likes of that', () => {
    ...
    expect(listHelper.totalLikes(blogs.slice(1, 2))).toBe(5)
    expect(listHelper.totalLikes(blogs.slice(4, 5))).toBe(0)
  })
...
describe('favorite blog', () => {
  ...
  test('of bigger list is calculated right', () => {
    expect(listHelper.favoriteBlog(blogs.slice(0, 2))).toEqual({
      title: 'React patterns',
      author: 'Michael Chan',
      url: 'https://reactpatterns.com/',
      likes: 7,
...
describe('most blogs', () => {
  ...
  test('of bigger list is calculated correctly', () => {
    expect(listHelper.mostBlogs(blogs.slice(0, 3))).toEqual({
      author: 'Edsger W. Dijkstra',
      blogs: 2,
    })
